...
([[https://nas-t.net][NAS-T]]). Development is done at [[https://lab.rwest.io/comp/startup/nas-t][lab.rwest.io/comp/startup/nas-t]] and
mirrored on [[https://github.com/richardwesthaver/nas-t][github]].
- STATUS :: ALPHA
- LICENSE :: [[file:LICENSE][MPL]]
** Introduction
Welcome to the NAS-T codebase. For more about The NAS Technology
Company refer to the [[file:ABOUT][ABOUT]] file.
...
- [2023-08-01 Tue] :: /a note from the author/ \\
  ...
  encourage others to do the sam. There is much work to be done but
...
** TODO MVP
:LOGBOOK:
- State "TODO"       from              [2023-08-01 Tue 17:27]
:END:
